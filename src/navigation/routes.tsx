...
import { MemePadPage } from '@/pages/MemePadPage/MemePadPage';
...
export const routes: Route[] = [
  ...
  { path: '/token', Component: TokenDetailPage },
  { path: '/create-token', Component: CreateTokenPage, title: 'Create Token' },
  { 
    path: '/my-tokens',
